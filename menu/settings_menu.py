...
class SettingsMenu(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self._sensitivity_var = ctk.StringVar()
        self.sensitivity_input = ctk.CTkEntry(self, textvariable=self._sensitivity_var, border_width=1, border_color="#404040", fg_color="#1A1A1A", text_color="#FFFFFF")
    ...
    def get_game_sensitivity(self) -> float:
        ...
        try:
            sens = float(self._sensitivity_var.get().strip())
    ...
    def get_config(self) -> dict:
        return {
            ...
            "game_sensitivity": self._sensitivity_var.get().strip(),
        }
    ...
    def load_config(self, data: dict) -> None:
        ...
        if sensitivity:
            self._sensitivity_var.set(sensitivity)
